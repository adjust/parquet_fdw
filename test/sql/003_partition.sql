...
\set filepart1 :abs_srcdir '/data/partition/example_part1.parquet'
\set filepart2 :abs_srcdir '/data/partition/example_part2.parquet'

CREATE FOREIGN TABLE example_part1
PARTITION OF example_part FOR VALUES FROM ('2018-01-01') TO ('2018-02-01')
SERVER parquet_srv
OPTIONS (filename :'filepart1', sorted 'id date');

CREATE FOREIGN TABLE example_part2
PARTITION OF example_part FOR VALUES FROM ('2018-02-01') TO ('2018-03-01')
SERVER parquet_srv
OPTIONS (filename :'filepart2', sorted 'id date');
